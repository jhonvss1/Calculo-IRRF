...
else if (Salario >= 1903.99 && Salario <= 2826.65)
{
    ...
    var desconto = Salario * (7.50 / 100);
    var descontado = Salario - desconto;
...
else if (Salario >= 2826.66 && Salario <= 3751.05)
{
    ...
    var desconto = Salario * (15.00 / 100);
    var descontado = Salario - desconto;
...
{
    var desconto = Salario * (22.50 / 100);
    var descontado = Salario - desconto;
...
{
    var desconto = Salario * (27.50 / 100);
    var descontado = Salario - desconto;
